...
namespace NotifyApp
{
    ...
    sealed partial class App : Application
    {
        ...
        private async Task SaveProfilePicToAppData()
        {
            ...
            StorageFile profilePic = await StorageFile.GetFileFromApplicationUriAsync(new System.Uri("ms-appx:///Assets/notification.png"));

            // And now cache their profile pic in the app
            await profilePic.CopyAsync(ApplicationData.Current.LocalFolder, "notification.png", NameCollisionOption.ReplaceExisting);
        }
